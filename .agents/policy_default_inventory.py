...
ALLOWED_CATALOG_OCCURRENCES = {
    ...
    ("verification_efficiency", "plugins/zzzops/skills/suggest-zzzops-work/SKILL.md"): "selected-value interpreter",
    ("verification_efficiency", "plugins/zzzops/skills/execute-zzzops/references/ENTROPY_OBSERVATIONS.md"): "runtime category schema",
    ("verification_efficiency", "plugins/zzzops/skills/suggest-zzzops-work/references/VERIFICATION_EFFICIENCY.md"): "selected-value interpreter",
