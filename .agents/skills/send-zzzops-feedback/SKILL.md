...
2. Run `report list` and inspect every valid archived report. Malformed or unknown report content is a safety failure; stop without submitting or deleting anything.
