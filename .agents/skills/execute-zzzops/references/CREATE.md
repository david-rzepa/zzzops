...
2. Promptly create a provisional canonical goal using `BACKENDS.md`: a managed issue or a local file from `.agents/templates/project-goals/GOAL.md`; use `new`, `P2`, difficulty `unknown`, confidence `low` unless evidence says otherwise.
