...
4. If consequential ambiguity remains, follow `.zzzops/rules/BLOCKERS.md`: record it, expose the portfolio-derived human queue, and interview per PROJECT policy with recommendations and continuation boundaries. Proceed on reversible cosmetic assumptions; never speculate across foundational choices.
