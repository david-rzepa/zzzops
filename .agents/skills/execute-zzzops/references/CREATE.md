...
2. Promptly create a provisional file from `goals/TEMPLATE.md`: `new`, `P2`, difficulty `unknown`, confidence `low` unless evidence says otherwise.
...
10. Update goal, backlinks, affected index rows, `needs_human`, and history atomically. If execution was requested, continue with `EXECUTE.md`.
