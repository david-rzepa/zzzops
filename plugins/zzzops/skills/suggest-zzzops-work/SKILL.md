...
Run `../../rules/INITIALIZATION.md`, then `../../rules/BACKENDS.md`. Read project instructions, charter, and minimal discovery; hydrate only likely duplicate bodies, and history only when current intent is insufficient.
