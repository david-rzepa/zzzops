...
5. Migration blockers require `legacy_migration`: missing settings require re-review; ambiguity blocks; only explicit `never_released` authorizes bounded replacement of affected project-owned state. Never infer that state can be wiped.
