...
Update only for new result, decision, risk, changed assumption, required action, or long-operation heartbeat; never recap unchanged state. Before new-goal work, state outcome/scope.
