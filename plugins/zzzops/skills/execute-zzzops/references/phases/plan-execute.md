...
Run this prompt only when the public workflow returns this exact step. Produce a bounded implementation plan from the reviewed inputs without silently widening the goal.
