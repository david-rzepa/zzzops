...
Run this prompt only when a `zzzops workflow` checkpoint returns this exact step. Independently verify the criterion-to-test trace, baseline failure, exclusions, and that the tests represent the requested behaviour.
