...
Run this prompt only when the public workflow returns this exact step. Check the plan against the goal, repository evidence, dependencies, and likely downstream consequences.
