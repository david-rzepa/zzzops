...
Run this prompt only when the public workflow returns this exact step. Split a non-atomic parent into independently deliverable child goals; mark the phase not required only under the supplied atomic-goal policy rule.
