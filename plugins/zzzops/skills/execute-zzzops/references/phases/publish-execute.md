...
Run this prompt only when a `zzzops workflow` checkpoint returns this exact step. Prepare the approved result for publication using the supplied stack and repository constraints.
