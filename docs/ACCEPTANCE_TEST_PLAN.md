...
Expected: the installed package contains `plugin.json`, eight skills, `rules/`, and `zzzops/`; Codex discovers the eight skills in the new task. Installation does not modify the target repository or initialize project policy.
