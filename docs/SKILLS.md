...
| `send-zzzops-feedback` | send, submit, feedback; execution reports | Preview the exact public payload | Exact digest confirmation: create one public ZzzOps issue and delete only submitted reports |
