...
`$suggest-zzzops-work` audits code, tests, documentation, configuration, and policy for evidence-backed improvements. Suggestions are preview-only unless apply or a reviewed exhausted-queue refill policy authorizes goal creation.
